...
$PAGE_TITLE = 'Manage Species family category';
$URL_NAME = 'manage-family';
                            ...
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <small class="text-muted float-end"><a href="add-family"
                                                class="btn btn-danger">Add
                                                Species Family</a></small>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <table id="example" class="table table-striped" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php if (
                                                    $species_families = $AdminTask->Get_Family_Cati()
                                                ) {
                                                    $sn = 0;
                                                    foreach (
                                                        $species_families
                                                        ...
                                                        $sn++; ?>
                                                <tr id="<?= $species_family->id ?>">
                                                    <td><?= $sn ?></td>
                                                    <td><?= $species_family->family_name ?></td>
                                                    <td>
                                                        <button type="button" title="Edit"
                                                            class="btn rounded-pill btn-icon btn-primary"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#Edit_<?= $species_family->id ?>">
                                                            <span class="tf-icons bx bx-pen"></span>
                                                        </button>
                                                        <button type="button" title="Delete"
                                                            class="btn rounded-pill btn-icon btn-danger"
                                                            onClick="window.confirm('Are you sure want to delete this item ?') && delete_data_ajax('disabled_data', 'family_cati', '<?= $species_family->id ?>')">
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="Edit_<?= $species_family->id ?>"
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="modalCenterTitle">Edit
                                                                        Family [<?= $species_family->family_name ?>]
                                                                    </h5>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col mb-3">
                                                                            <label for="speciesName"
                                                                                class="form-label">Species Name</label>
                                                                            <input type="text"
                                                                                id="familyName_<?= $species_family->id ?>"
                                                                                class="form-control"
                                                                                placeholder="Enter Name"
                                                                                name="familyName"
                                                                                value="<?= $species_family->family_name ?>"
                                                                                required />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <input type="button" class="btn btn-primary"
                                                                        onClick="edit_data_ajax('edit_family', 'table', '<?= $species_family->id ?>')"
                                                                        value="Save changes">
                                                                </div>
                                                            </div>
                                                        </form>
    ...
    function edit_data_ajax(action, table, code) {
        ...
        $.ajax({
            ...
            if (data == true) {
                ...
                $.Toast("Success!", "Species Successful Updated !", "success", {
                    has_icon: true,
                    has_close_btn: true,
                    width: 300,
                    stack: true,
