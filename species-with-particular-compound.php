...
if (!empty($_GET['comp'])) {
    $link = strip_tags(trim($_GET['comp']));
    if ($compound_props = $AdminTask->Get_Single_Compound($link)) {

        $PAGE_TITLE =
            'Plant Species That Contained: ' . $compound_props->compounds_name;
...
<body>
    ...
    <div class="page">
        ...
        <section
            ...
            style="background-image: url(images/plant-species-slider-image-6.jpg); background-size: cover; background-position: center bottom; background-attachment: initial;">
            <div class="container">
        ...
        <!--        <div class="swiper-slide" data-slide-bg="images/plant-species-slider-image-5.jpg">-->
            ...
            <div class="container-fluid">
                ...
                <table id="example" class="table table-striped table-bordered display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href=' species-details?specy= <?= $specy->species_link ?>'><?= $specy->species_name ?></a></td>
                            <td><?= $specy->family_name ?></td>
                            <td><?= $specy->common_name ?></td>
                            <td><?= $specy->local_name ?></td>
                            <td><a href='species-compounds-list?specy=<?= $specy->species_link ?>'><?= $AdminTask->Get_Count_Nums_Of_Compunds_Species(
    $specy->id
)->totalCount ?></a></td>
                            <td><?= $specy->ids_no ?></td>
